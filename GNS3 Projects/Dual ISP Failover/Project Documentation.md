...
# Conclusion
This project is an extension of my previous Packet Tracer projects, taking the WAN setup a step further by using GNS3. I wanted to simulate a dual-ISP environment with automatic failover, which was difficult to achieve in Packet Tracer.

I used IP SLA tracking and Policy-Based Routing with route maps to automatically reroute traffic from ISP-A to ISP-B when the primary connection goes down. This project gave me a better understanding of WAN redundancy, traffic management, and how network engineers can improve connectivity and availability in an enterprise environment.
